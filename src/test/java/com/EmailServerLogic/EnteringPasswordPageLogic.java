...
//
//public class EnteringPasswordPageLogic implements ILoginPage{
...
//    }
//
//    public EnteringPasswordPageLogic enterCredentials(String keys){
//        WebElement passwordFieldElement = driver.findElement(passwordField);
//        passwordFieldElement.click();
//        passwordFieldElement.sendKeys(keys);
//        return this;
//    }
//    public ILoginPage verifyIfToggled(){
