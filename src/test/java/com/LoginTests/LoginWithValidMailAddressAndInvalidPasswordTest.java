...
public class LoginWithValidMailAddressAndInvalidPasswordTest {
   ...
   @Test()
    public void verifyImpossibilityOfLoginWithInvalidPassword(){
       String address = "testingepam@yahoo.com";
       String invalidPassword = String.valueOf( (int)(Math.random() * 10));
       String expectedBorderStyle = "1px solid rgb(255, 51, 58)";
       String expectedWarningMessage = "Invalid password. Please try again";
   ...
   public void assertPasswordNotAccepted(){
